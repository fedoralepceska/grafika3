                            ...
                            <div class="jobDetails p-2">
                                <div class="border">
                                    ...
                                    <div class="flex p-2 gap-10">
                                        ...
                                        <div>{{$t('totalm')}}<sup>2</sup>: <span class="bold">{{((job.height * job.width) / 1000000 * job.copies).toFixed(4)}}</span></div>
                                    </div>
                                    ...
                                    <div class="jobInfo relative">
                                        ...
                                        <div class="jobPriceInfo absolute right-0 bottom-0 bg-white text-black bold">
                                            <div class="p-2">
                                                {{$t('jobPrice')}}: <span class="bold">{{job.price.toFixed(2)}} ден.</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
