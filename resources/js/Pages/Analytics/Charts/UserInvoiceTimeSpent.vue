<template>
    <div class="p-6 rounded-lg shadow-lg">
        <h2 class="text-2xl font-bold text-white mb-6">Worker Analytics</h2>
        ...
        <div class="mt-8">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full bg-white text-black">
                    ...
                    <tr>
                        <th class="py-2 px-4 text-left">Worker ID</th>
                        <th class="py-2 px-4 text-left">Total Time Spent</th>
                        <th class="py-2 px-4 text-left">Invoices Worked On</th>
                    </tr>
                    </thead>
                    <tbody>
